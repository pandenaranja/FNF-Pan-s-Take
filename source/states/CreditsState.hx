...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("Checking credits from funny mod :D", null);
		#end

		persistentUpdate = true;
		bg = new FlxSprite().loadGraphic(Paths.image('AmazingCreditsImage'));
		...
		descText.setFormat(Paths.font("MorningRainbow.ttf"), 32, FlxColor.ORANGE, CENTER/*, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK*/);
