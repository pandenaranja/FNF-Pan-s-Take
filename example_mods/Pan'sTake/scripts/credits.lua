...
local songData = { -- The main table that contains the songs you want credits on
    ...
    ['crimson-start'] = { -- This name NEEDS to be the name in the direct JSON/chart (e.g: dad-battle).
        ["songName"] = "Crimson Start", -- The display name of the song.
        ["length"] = 5, -- The length the box is on screen.
        ["boxColor"] = "#000000", -- Color of Box (IN HEX).
        ["textColor"] = "#FFFFFFF", -- Color of Text (IN HEX).
        ...
        -- IF YOU WANT ME TO MAKE IT TO BE IN ORDER, LEAVE A COMMENT ON THE GAMEBANANA PAGE AND I'LL DO IT!
            ["Composer"] = "pandenaranja",
            ["Artist"] = "pandenaranja",
            ["Charter"] = "pandenaranja",
        },
    },
...
function onCreatePost()
    ...
    if songTableMAIN then
        ...
        if not options["noCredits"] then
            ...
            makeLuaText('songPlaying', "This song is called:", objWidth, offsetX - objWidth, offsetY+25)
